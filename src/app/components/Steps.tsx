...
export default function PackagesSection() {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-3 sm:px-6 md:px-10 relative z-10">
        {/* Heading */}
        <motion.div
        ...
        >
          <h2
            className={`${orbitronFont.className} text-3xl sm:text-4xl md:text-5xl font-bold mb-4 
            ...
            >
              ...
              >
                ...
                <motion.div
                  ...
                  className="absolute -top-4 right-6 px-4 py-2 
                ...
                <ul className="space-y-2 text-gray-200 mb-6 text-base sm:text-lg">
